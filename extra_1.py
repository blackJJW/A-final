...
class Set_Data:
    def __init__(self, df):
        print("extra_1 - Set_Data  Start")
        self.stock_file_name = df
        
        self.refine_data()
        
    def refine_data(self):
        print("extra_1 - Set_Data - refine_data Start")
        company_stock = self.stock_file_name
        print("----- dropping columns Start -----")
        try:
            company_stock_1 = company_stock.drop(columns=["Unnamed: 0", "index","등락률","거래대금","시가총액","상장주식수"])
        except:
            company_stock_1 = company_stock.drop(columns=["Unnamed: 0", "index","Unnamed: 0.1","등락률","거래대금","시가총액","상장주식수"])
        ...
        try:
            #컬럼명을 영어로 바꿈
            company_stock_1.columns = ['date', 'close', 'diff' , 'start', 'high' ,'low', 'volume', 'sumPos', 'sumNeg']
            company_stock_1 = company_stock_1.set_index('date') # date를 index로 설정
        except:
            company_stock_1 = company_stock_1.drop(columns = ["Unnamed: 0.1"])
            company_stock_1.columns = ['date', 'close', 'diff' , 'start', 'high' ,'low', 'volume', 'sumPos', 'sumNeg']
            company_stock_1 = company_stock_1.set_index('date') # date를 index로 설정
        print("----- changing column names Done -----")
        self.df = company_stock_1
        print("extra_1 - Set_Data - refine_data Done")
        
    def return_df(self):
        print("extra_1 - Set_Data  Done")
        return(self.df)
               
class Extra_Features_1:
    def __init__(self, df):
        print("extra_1 - Extra_Features_1  Start")
        self.df = df
    ...
    def return_df(self):
        print("extra_1 - Extra_Features_1  Done")
        return(self.df)
    
class ML_Part_1:
    def __init__(self, stock_file_name):
        print("extra_1 - ML_Part_1  Start")
        self.df =  pd.read_csv('./data/stock/extra_s/'+stock_file_name, encoding='cp949')
    ...
    def ready(self):
        print("extra_1 - ML_Part_1 - ready  Start")
        ...
        print("extra_1 - ML_Part_1 - ready  Done")
         
    def cross_accuracy(self):
        print("extra_1 - ML_Part_1 - cross_accuracy  Start")
        ...
        temp = sys.stdout
        sys.stdout = open('./data/report/cv_acc/'+self.stock_file_name+'_extra_s_cv_accuracy_report.txt', 'w')
        ...
        print("extra_1 - ML_Part_1 - cross_accuracy  Done")

        
    def income_rate(self):
        print("extra_1 - ML_Part_1 - income_rate  Start")
        ...
        temp = sys.stdout           
        sys.stdout = open('./data/report/income_rate/'+self.stock_file_name+'_extra_s_income_rate_report.txt', 'w')
        ...
        print("extra_1 - ML_Part_1 - income_rate  Done")
        print("extra_1 - ML_Part_1  Done")
