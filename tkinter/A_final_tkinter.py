...
stock_options['values']=('google','msft')
stock_options.current(0) #인덱스 0번째가 콤보 상자에 표시되는 것
...
graph_button=tk.Button(win,font=('times',10,'bold'),text='Graph',command=window)
graph_button.grid(row=3,column=2)

conclusion_button=tk.Button(win,font=('times',10,'bold'),text='conclusion',command=conclusion)
conclusion_button.grid(row=6,column=0)
...
conclusion=tk.Message(win,font=('times',15,'bold'))
conclusion.grid(row=6,column=1)
