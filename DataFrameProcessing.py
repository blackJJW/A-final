...
class Get_Stock_DF:
    def __init__(self, company_name, company_code, date1, date2, dir_path, prob):
        print("DataFrameProcessing - Get_Stock_DF Start")
    ...
    def download_stock_data(self):
        print("DataFrameProcessing - Get_Stock_DF - download_stock_data Start")
        print("----- setting chromedriver Start -----")
        ...
        print("----- setting chromedriver Done -----")
        ...
        print("DataFrameProcessing - Get_Stock_DF - download_stock_data Done")
        
        self.gen_stock_data_df()
        
    #-----------회사 주식 데이터 ---------------------------------------------------------------------------------------------
    def gen_stock_data_df(self):
        print("DataFrameProcessing - Get_Stock_DF - gen_stock_data_df Start")
        print("----- reading / sorting csv Start -----")
    ...
    def gen_stock_data_total_df(self):
        ...
        print("----- trandforming date type Start -----")
        for i in tqdm(range(len(company_data))): # 리스트에 data append
        ...
        print("----- trandforming date type Done -----")

        print("----- creating / setting column Start -----")
        ...
        #---------------------------------------------------------------------------------------------------------------------------------------------
        print("----- creating / setting column Done -----")
        print("----- saving file Start -----")
        ...
        print("----- saving file Done -----")
        print("DataFrameProcessing - Get_Stock_DF - gen_stock_data_total_df Done")
        print("DataFrameProcessing - Get_Stock_DF  Done")
#---------------------------------------------------------------------------------------------------------------------------------------------------------------
