...
class Set_Data:
    def __init__(self, stock_file_name):
        print("Part_1_ML - Set_Data  Start")
        self.stock_file_name = stock_file_name
        
        self.refine_data()
        
    def refine_data(self):
        print("Part_1_ML - Set_Data - refine_data Start")
        ...
        print("Part_1_ML - Set_Data - refine_data Done")
        print("Part_1_ML - Set_Data  Done")
        
class ML_Part_1:
    def __init__(self, stock_file_name):
        print("Part_1_ML - ML_Part_1  Start")
    ...
    def ready(self):
        print("Part_1_ML - ML_Part_1 - ready  Start")
        ...
        print("Part_1_ML - ML_Part_1 - ready  Done")
        
    def cross_accuracy(self):
        print("Part_1_ML - ML_Part_1 - cross_accuracy  Start")
        ...
        print("Part_1_ML - ML_Part_1 - cross_accuracy  Done")
        
    def income_rate(self):
        print("Part_1_ML - ML_Part_1 - income_rate  Start")
        ...
        print("Part_1_ML - ML_Part_1 - income_rate  Done")
        print("Part_1_ML - ML_Part_1  Done")